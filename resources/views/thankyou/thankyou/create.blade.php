...
<div class="content-header row">
    <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Thankyou</h3>
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" href="{{url('admin/dashboard')}}">Home</li>
                    <li class="breadcrumb-item active">Thankyou</li>
                    <li class="breadcrumb-item active">Create New Thankyou</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{url('/thankyou/thankyou')}}">View Thankyou</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  <div class="card-header">
                      <h4 class="card-title" id="basic-layout-form">Thankyou Info</h4>
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::open(['url' => '/thankyou/thankyou', 'files' => true]) !!}
                        @include ('thankyou.thankyou.form')
                        {!! Form::close() !!}
                       </div>
                  </div>
              </div>
