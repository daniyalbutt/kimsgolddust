...
<div class="content-header row">
        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Shipping #{{ $shipping->id }}</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{ url('/shippings/shippings') }}">Back</a>
        </div>
    </div>
</div>
              ...
              <div class="card">
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::model($shipping, [
                            'method' => 'PATCH',
                            'url' => ['/shippings/shippings', $shipping->id],
                            'files' => true
                        ]) !!}

                        @include ('shippings.shippings.form', ['submitButtonText' => 'Update'])
...
<script>
  ...
  <script>
        ...
        function deleteAttr(tax_id, a){
            var e = a;
            var id = tax_id;
            $.ajax({
                url: "{{ route('delete.tax.variant')}}",
                type:"POST",
                data:{
                    "_token": "{{csrf_token()}}",
                    id:id
