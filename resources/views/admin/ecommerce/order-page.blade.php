  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      ?>
            ...
            <td> <img src="{{asset($product->image)}}" width="120" alt="" title=""> </td> 
      ...
      ?>
                ...
                <tr>
                  ...
                  <td class="custom-product text-right">${{ $subtotal }}</td>
                </tr>
                <tr>
                  <td class="no-border" colspan="2">&nbsp;</td>
                  <td colspan="3" class="text-muted no-border">Discount Price:
                  </td>
                  <td class="no-border text-right">-${{$order->discount == null ? 0 : $order->discount}}</td>
                </tr>
                <tr>
                  <td class="no-border" colspan="2">&nbsp;</td>
                  <td colspan="3" class="text-muted no-border">Shipping Price:
                  </td>
                  <td class="no-border text-right">+${{$order->shipping_tax == null ? 0 : $order->shipping_tax}}</td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="no-border text-right">${{(float)($order->order_total - ($order->discount == null ? 0 : $order->discount)) + (float)($order->shipping_tax == null ? 0 : $order->shipping_tax)}}</td>
              ...
              <table class="table m-b-5 m-t-20 ">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-color">{{$order->order_company}}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="text-color">{{$order->delivery_address_1}}, {{$order->delivery_address_2}}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="text-color">{{$order->order_notes}}</td>
                  </tr>
                </tbody>
              </table>
            </div>
