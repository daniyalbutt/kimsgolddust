                                  ...
                                  <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="upload-photo">
                                                    ...
                                                    <div class="form-group mt-1 alert alert-info">
                                                        ...
                                                        <input type="text" name="image_alter_tag" class="form-control" value="{{ $page->right_image_alter_tag }}">
                                                    </div>
                                                </div>
                                              </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="upload-photo">
                                                    <input type="file" name="right_image" id="right_image" class="dropify" />
                                                    <div class="form-group mt-1 alert alert-info">
                                                        <label style="color: white;">Add Alter Text of Upper Image</label>
                                                        <input type="text" name="right_banner_alter_tag" class="form-control" value="{{ $page->right_image_alter_tag }}">
                                                    </div>
                                                </div>
                                              </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="upload-photo">
                                                    <input type="file" name="front_image" id="front_image" class="dropify" />
                                                    <div class="form-group mt-1 alert alert-info">
                                                        <label style="color: white;">Add Alter Text of Upper Image</label>
                                                        <input type="text" name="front_image_alter_tag" class="form-control" value="{{ $page->right_image_alter_tag }}">
                                                    </div>
                                                </div>
                                              </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="shop_link" type="text" id="shop_link">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="additonal_class" type="text" id="additonal_class">
                                            </div>
                                        </div>
                                  </div>
                              </div>
