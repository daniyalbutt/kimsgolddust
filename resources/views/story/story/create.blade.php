...
<div class="content-header row">
        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create New Story</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{url('/story/story')}}">View Story</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::open(['url' => '/story/story', 'files' => true]) !!}
                        @include ('story.story.form')
                        {!! Form::close() !!}
                       </div>
                  </div>
              </div>
