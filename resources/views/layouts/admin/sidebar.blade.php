    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ (request()->is('admin/users') || request()->is('admin/users/*')) ? 'active' : '' }}">
                <a href="{{url('admin/users')}}"><i class="la la-users"></i><span class="menu-title" data-i18n="Dashboard">VIP Insider Users</span></a>
            </li>
            ...
            <li class="nav-item {{ (request()->is('admin/redirection') || request()->is('admin/redirection/*')) ? 'active' : '' }}">
                <a href="{{url('admin/redirection')}}"><i class="la la-refresh"></i>
                    <span class="menu-title" data-i18n="eCommerce">Redirection</span>
                </a>
            </li>
            ...
            @foreach($laravelAdminMenus->menus as $section)
                ...
                @endif
            @endforeach
            <li class="nav-item {{ (request()->is('admin/tax') || request()->is('admin/tax/*')) ? 'active' : '' }}">
                <a href="{{url('admin/tax')}}"><i class="la la-dollar"></i>
                    <span class="menu-title" data-i18n="eCommerce">Tax</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="javascript:;"><i class="la la-envelope"></i><span class="menu-title" data-i18n="Dashboard">Email Format</span></a>
                <ul class="menu-content">
                    <li class="{{ (request()->is('thankyou/thankyou') || request()->is('thankyou/thankyou/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('thankyou/thankyou')}}"><i></i>
                            <span data-i18n="eCommerce">Contact Email</span>
                        </a>
                    </li>
                    <li class="{{ (request()->is('newsletteremail/newsletteremail') || request()->is('newsletteremail/newsletteremail*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('newsletteremail/newsletteremail')}}"><i></i>
                            <span data-i18n="eCommerce">Nesletter Email</span>
                        </a>
                    </li>
                    <li class="{{ (request()->is('orderemail/orderemail') || request()->is('orderemail/orderemail/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('orderemail/orderemail')}}"><i></i>
                            <span data-i18n="eCommerce">Order Email</span>
                        </a>
                    </li>
                    <li class="{{ (request()->is('newaccount/newaccount') || request()->is('newaccount/newaccount/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('newaccount/newaccount')}}"><i></i>
                            <span data-i18n="eCommerce">New Account Email</span>
                        </a>
                    </li>
                    <li class="{{ (request()->is('resetpassword/resetpassword') || request()->is('resetpassword/resetpassword/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('resetpassword/resetpassword')}}"><i></i>
                            <span data-i18n="eCommerce">Reset Password Email</span>
                        </a>
                    </li>
                </ul>
            ...
            <li class="nav-item">
                <a href="{{url('admin/account/settings')}}"><i class="la la-asterisk"></i>
